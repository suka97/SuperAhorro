...
//
//
//class CartItemGroupie (
//    var cartItemsList:MutableList<CartItem>,
//    var onItemClick : (Int) -> Unit,
//    var onItemDelete : (Int) -> Unit
//) : GroupAdapter<CartItemGroupie.ItemHolder>() {
//    class ItemHolder (val cartItem: CartItem) : GroupieViewHolder(v) {
...
//        clear()
//        val groupedItems = cartItemsList.groupBy { it.brand }
//        groupedItems.forEach { (category, items) ->
//            val group = Section()
//            items.forEach { cartItem ->
//                group.add(ItemHolder(cartItem))
//            }
//            add(group)
//        }
//    }
